		    ...
		    out.print("<section>");
			   ...
			   while(rs.next())
			   {
				  ...
				  // out.print("<td style='border-bottom: 1px black solid;'>");
				   ...
				   if(rs.getString(3).toString().contains("washington"))
					   out.print("<option  value='washington' selected>washington</option>");
						   ...
						   out.print("<option  value='washington'>washington</option>"); 
				   
				   if(rs.getString(3).toString().contains("omaha"))
					   out.print("<option  value='omaha' selected>omaha</option>");
					   else
						   out.print("<option  value='omaha'>omaha</option>");
				 ...
				 //  out.print("</td>");
				   out.print("<p> </p>");
				   out.print("<div>");
				   out.print("<input type='submit' name='submit' value='Modify'/> ");
